...
public class EmployeeService {
    ...
    @Autowired
    public EmployeeService(EmployeeRepository employeeRepository, PasswordEncoder passwordEncoder, @Lazy ReportRepository reportRepository, @Lazy ReportService reportService) {
    ...
    public ErrorKinds delete(String code, UserDetail userDetail) {
        ...
        List<Report> reportList = reportRepository.findReportsByEmployeeCode(code);
